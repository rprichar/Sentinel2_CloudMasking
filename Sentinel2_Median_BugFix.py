...
SENTINEL_2_CLEAR_PIX_VALS = [2, 4, 5, 6, 7, 11]
FILTER_VAL = -3001
...
class Sen2_Median:
    ...
    def __init__(self):
        self.name = 'Sentinel-2 Median Pixel Values Per Band'
        self.description = 'This function creates a synthetic Sentinel-2 image given a day of year range' \
    ...
    def updatePixels(self, tlc, shape, props, **pixelBlocks):
        ...
        try:
            ...
            pix_array_filtered = apply_mask(pix_array_filtered.astype('f4'), bqa_stack, SENTINEL_2_CLEAR_PIX_VALS)
